function [tpr] = tfr_L1(tfr,Pmax,method)
...
% Strength_vs_Period_L1(x,Pmax,method) by S.V. Tenneti and P. P. Vaidyanathan
...
for l = 1:size(tfr,2)
    ...
    DD = diag((1./penalty_vector));
    
    [s, history] = basis_pursuit(A*DD, x, 100, 1);
    %s = DD*s;
